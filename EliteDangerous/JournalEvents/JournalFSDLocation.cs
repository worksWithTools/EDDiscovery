...
namespace EliteDangerousCore.JournalEvents
{
    ...
    public class JournalFSDJump : JournalLocOrJump, IShipInformation, ISystemStationEntry
    {
        ...
        public JournalFSDJump(JObject evt) : base(evt, JournalTypeEnum.FSDJump)
        {
            ...
            MapColor = jm?.Int(EliteDangerousCore.EliteConfigInstance.InstanceConfig.DefaultMapColour)?? EliteDangerousCore.EliteConfigInstance.InstanceConfig.DefaultMapColour;
            if (jm?.Empty()??true)
